...
const messages = {
  en: {
    ...
    contact_us_title: "Have any questions? Let's connect.",
    about_us_content:
    ...
    contact_us_content: "If you have any questions related to the products offered by Tandra, you can contact us. Our team will be happy to help you with your questions.",
    company_name: "Tandra Ayur Usha India Private Limited"
    },
  kn: {
    home: "ಮುಖಪುಟ",
    about_us: "ನಮ್ಮ ಬಗ್ಗೆ",
    ...
    contact_us_title: "ಯಾವುದಾದರೂ ಪ್ರಶ್ನೆ ಇದೆಯೇ? ನಾವು ಸಂಪರ್ಕಿಸೋಣ",
    about_us_content:
    ...
    contact_us_content: "ತಾಂಡ್ರ ನೀಡುವ ಉತ್ಪನ್ನಗಳಿಗೆ ಸಂಬಂಧಿಸಿದ ಯಾವುದೇ ಪ್ರಶ್ನೆಗಳನ್ನು ನೀವು ಹೊಂದಿದ್ದರೆ, ನೀವು ನಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಬಹುದು. ನಿಮ್ಮ ಪ್ರಶ್ನೆಗಳಿಗೆ ಸಹಾಯ ಮಾಡಲು ನಮ್ಮ ತಂಡವು ಸಂತೋಷವಾಗುತ್ತದೆ.",
    company_name: "ತಾಂಡ್ರ ಆಯೂರ್‌ ಉಷಾ ಇಂಡಿಯಾ ಪ್ರೈವೇಟ್‌ ಲಿಮಿಟೆಡ್",
    }
};
